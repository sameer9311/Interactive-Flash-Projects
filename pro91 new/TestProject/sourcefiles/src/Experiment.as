...
/* My screen propeties variables */

private var h:Number;
private var w:Number;
private var scr:FlexGlobals;
...
public function Experiment(pie:PIE)
{
	...
	arrow1 = new PIEarrow(pieHandle, 325*(w/800), 135*(h/600), 325*(w/800), 195*(h/600) , displayFColor);
...
public function interactfunc():void
{
	...
	scann = new PIEinput(pieHandle, "", 6, 30*(h/600), displayBColor, displayFColor);
	scann.x  = 300*(w/800);
	scann.y  = 100*(h/600);
	scann.width = 100*(w/800);
	scann.height = 40*(h/600);
	scann.border = true;
...
public function guidedfunc():void
{
	...
	label8 = new PIElabel(pieHandle, "X", 25, displayBColor, displayFColor);
	label8.x = 450*(w/800);
	label8.y = 200*(h/600);
	...
	scann2 = new PIEinput(pieHandle, "", 5, 30*(h/600), displayBColor, displayFColor);
	scann2.x  = 500*(w/800);
	scann2.y  = 200*(h/600);
	scann2.width = 100*(w/800);
	scann2.height = 40*(h/600);
	scann2.border = true;
	
	scann3 = new PIEinput(pieHandle, "", 6, 30*(h/600), displayBColor, displayFColor);
	scann3.x  = 300*(w/800);
	scann3.y  = 250*(h/600);
	scann3.width = 100*(w/800);
...
public function testfunc():void
{
	...
	scann = new PIEinput(pieHandle, " ", 10, 30*(h/600), displayBColor, displayFColor);
	scann.x  = 300*(w/800);
	scann.y  = 200*(h/600);
	scann.width = 200*(w/800);
	scann.height = 40*(h/600);
	scann.border = true;
	pieHandle.addDisplayChild(scann);
	scann.visible = true;
