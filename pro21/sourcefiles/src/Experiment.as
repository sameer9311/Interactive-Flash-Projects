...
public function slide1():void
{
	...
	t1 = new PIElabel(pieHandle, "PRONOUNS ", 55, displayBColor, 0XE1DC28 );
...
public function slide2():void
{
	...
	t1 = new PIElabel(pieHandle, "EXAMPLES :", 30, displayBColor,  0X347CB8);
	pieHandle.addDisplayChild(t1);
	t1.x = 30;
	t1.y = 30;
	t1.visible = true;
...
public function slide6():void
{
	...
	t1 = new PIElabel(pieHandle, "EXERCISES :", 30, displayBColor,  0X347CB8);
	pieHandle.addDisplayChild(t1);
	t1.x = 30;
	t1.y = 30;
	t1.visible = true;
...
{
	answerimage = new PIEimage(pieHandle, 100, 145, 30, 30, PIEimageLocation.cansImgPtr);
...
{
	answerimage = new PIEimage(pieHandle, 100, 145, 30, 30, PIEimageLocation.wansImgPtr);
	pieHandle.addDisplayChild(answerimage);
	answerimage.setPIEborder(false);
	answerimage.setPIEvisible();
